...
parser.add_argument('--data-dir', default='/workspace/try1/show', metavar='DIR',
                    help='path to dataset')
parser.add_argument('-o', '--output', default='/workspace/try1/eval_show', metavar='DIR',
                    help='path to output')
parser.add_argument('--cuda', action='store_true', default=True,
                    help='enables CUDA training')
parser.add_argument('--latest-ckpt', default='/workspace/try1/checkpoint_save/weight.pth', type=str, metavar='PATH',
...
def inference(args, model=None, g=None):
    ...
    # print('| mIou:', IoU.mean())
            ...
            if args.visualize:
                output = output.cpu()
                # visualize_result(origin_image, origin_thermal, output-1, batch_idx, args)
                visualize_result(output, batch_idx, args.output)
