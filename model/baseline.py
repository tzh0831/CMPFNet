...
#     def __init__(self, num_classes=9, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8]):
#         super().__init__()
#         self.num_classes = num_classes
